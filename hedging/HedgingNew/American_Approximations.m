function [Delta_approx, Del_Gam_approx,FullValue_approx ] = American_Approximations(S0,St,K1,K3,m1,m2,m3,T,tau,Rate,Sigma,NumOfTimeSteps,alpha,lambda,M)

%put = Call_1 + K1*exp(-Rate*T)- S0*exp(-Rate*T);
Call_1=priceOptionTrinCEVEAmericanTry1(S0, K1, Rate,T, ...
