function [Delta_approx, Del_Gam_approx,FullValue_approx ] = Bermudan_Approximations(S0,St,K1,K3,m1,m2,m3,T,tau,Rate,Sigma,NumOfTimeSteps, M_Bermudan,alpha,lambda,M)
