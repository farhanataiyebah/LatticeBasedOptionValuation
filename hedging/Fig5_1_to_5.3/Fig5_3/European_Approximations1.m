function [Delta_approx, Del_Gam_approx,FullValue_approx ] = European_Approximations1(S0,St,K1,K3,m1,m2,m3,T,...
                                                           tau,Rate,Sigma,NumOfTimeSteps,alpha,lambda,M)
%
...
Del_prfl    = m1*(interpolationGreeks_K1(S0,'pchip', 'Put','E', 'delta')) +  m2*(interpolationGreeks_K1(S0,'pchip', 'Call','E', 'delta'))...,  
                    + m3* (interpolationGreeks_K3(S0,'pchip', 'Call','E', 'delta'));
                
Gam_prfl    = m1*(interpolationGreeks_K1(S0,'pchip', 'Put','E', 'gamma')) +  m2*(interpolationGreeks_K1(S0,'pchip', 'Call','E', 'gamma'))...,  
                    + m3* (interpolationGreeks_K3(S0,'pchip', 'Call','E', 'gamma'));
