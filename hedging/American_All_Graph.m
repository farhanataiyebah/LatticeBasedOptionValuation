...
for i = 1:n 
    [American_del(i), American_delgam(i), American_full(i)] = American_Approximations(S0,St(i),K1,K3,mp,mc1,mc2,T_51,tau,r_51,est_sig,Call_1,Call_2,NumOfTimeSteps,alpha,lambda,M);
