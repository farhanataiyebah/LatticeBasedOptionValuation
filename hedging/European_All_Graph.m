...
for i = 1:n 
    [European_del(i), European_delgam(i), European_full(i)] = European_Approximations(S0,St(i),K1,K3,mp,mc1,mc2,T_51,tau,r_51,est_sig,Call_1,Call_2,NumOfTimeSteps,alpha,lambda,M);
