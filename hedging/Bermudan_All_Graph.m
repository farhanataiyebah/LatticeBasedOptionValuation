...
Bermudan_del    = zeros(1,n);
Bermudan_delgam = zeros(1,n);
Bermudan_full   = zeros(1,n);

for i = 1:n 
    [Bermudan_del(i), Bermudan_delgam(i), Bermudan_full(i)] =Bermudan_Approximations(S0,St(i),K1,K3,mp,mc1,mc2,T_51,tau,r_51,est_sig,Call_1,Call_2,NumOfTimeSteps,alpha,lambda,M);


end
figure(1)
plot(St,Bermudan_del,'kd')
hold on
plot(St,Bermudan_delgam,'k*')
hold on
plot(St,Bermudan_full,'k')
grid on
