function [ greeks ] = Interp_AuxLatticeGreeksBermudan(Underlying, Strike, r, T, ...
                NumOfTimeSteps,M_Bermudan, Sigma,alpha,lambda,M, StrCallPut, Strdeltagamma)


            
            
[x1,delta1, gamma1 ] = AuxLatticeGreeksBermudan(Underlying, Strike, r, T, ...
                NumOfTimeSteps,M_Bermudan, Sigma,alpha,lambda,M, StrCallPut);

[x2,delta2,gamma2]= AuxLatticeGreeksBermudan(min(x1), Strike, r, T, ...
                NumOfTimeSteps,M_Bermudan, Sigma,alpha,lambda,M, StrCallPut);
            k=0;
...
[x3,delta3,gamma3]= AuxLatticeGreeksBermudan(max(x1), Strike, r, T, ...
                NumOfTimeSteps,M_Bermudan, Sigma,alpha,lambda,M, StrCallPut);  
            k=0;
            for i=1:(2*NumOfTimeSteps+1)-4
            if (x3(i)>max(x1))
