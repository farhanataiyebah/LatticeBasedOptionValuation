...
Del_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','Ag', 'delta')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','Ag', 'delta'))...,  
                    + m3* (interpolationGreeks_K3(S0, type', 'Call','Ag', 'delta'));
                
Gam_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','Ag', 'gamma')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','Ag', 'gamma'))...,  
                    + m3* (interpolationGreeks_K3(S0, type, 'Call','Ag', 'gamma'));
