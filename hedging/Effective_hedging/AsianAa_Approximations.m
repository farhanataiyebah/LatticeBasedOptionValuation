function [Delta_approx, Del_Gam_approx,FullValue_approx ] = AsianAa_Approximations(S0,St,K1,K3,m1,m2,m3,T,...
                                                       tau,Rate,Sigma,NumOfTimeSteps,alpha,lambda,M, type)
...
Del_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','Aa', 'delta')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','Aa', 'delta'))...,  
                    + m3* (interpolationGreeks_K3(S0, type, 'Call','Aa', 'delta'));
                
Gam_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','Aa', 'gamma')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','Aa', 'gamma'))...,  
                    + m3* (interpolationGreeks_K3(S0, type, 'Call','Aa', 'gamma'));
