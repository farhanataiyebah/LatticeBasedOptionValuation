...
Del_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','E', 'delta')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','E', 'delta'))...,  
                    + m3* (interpolationGreeks_K3(S0, type, 'Call','E', 'delta'));
                
Gam_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','E', 'gamma')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','E', 'gamma'))...,  
                    + m3* (interpolationGreeks_K3(S0, type, 'Call','E', 'gamma'));
