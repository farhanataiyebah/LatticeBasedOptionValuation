function [Delta_approx, Del_Gam_approx,FullValue_approx ] = American_Approximations(S0,St,K1,K3,m1,m2,m3,T,...
...
Del_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','A', 'delta')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','A', 'delta'))...,  
                    + m3* (interpolationGreeks_K3(S0, type, 'Call','A', 'delta'));
                
Gam_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','A', 'gamma')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','A', 'gamma'))...,  
                    + m3* (interpolationGreeks_K3(S0, type, 'Call','A', 'gamma'));
