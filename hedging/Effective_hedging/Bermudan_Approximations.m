function [Delta_approx, Del_Gam_approx,FullValue_approx ] = Bermudan_Approximations(S0,St,K1,K3,m1,m2,m3,T,...
                                                       tau,Rate,Sigma,NumOfTimeSteps,M_Bermudan, alpha,lambda,M, type)
...
Del_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','B', 'delta')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','B', 'delta'))...,  
                    + m3* (interpolationGreeks_K3(S0, type, 'Call','B', 'delta'));
                
Gam_prfl    = m1*(interpolationGreeks_K1(S0, type, 'Put','B', 'gamma')) +  m2*(interpolationGreeks_K1(S0, type, 'Call','B', 'gamma'))...,  
                    + m3* (interpolationGreeks_K3(S0, type, 'Call','B', 'gamma'));
