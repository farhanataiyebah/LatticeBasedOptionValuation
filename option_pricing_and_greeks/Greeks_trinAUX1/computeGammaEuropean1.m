function [ Gamma ] = computeGammaEuropean1(Underlying, Strike, r, T, ...
...
Delta_usa11=(priceOptionTrinCEVEuropeanTry1(slat{5}(1), Strike, r, T, ...
            NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut)-...
            price)./(slat{5}(1)-S0);
         
         
Delta_dsa11=(price-...
            priceOptionTrinCEVEuropeanTry1(slat{5}(length(slat{5}(:))), Strike, r, T, ...
