function [ Gamma ] = computeGammaBermudan1(Underlying, Strike, r, T, ...
...
Delta_usa11=(priceOptionTrinCEVBermudanTry1(slat{5}(1), Strike, r, T, ...
            NumOfTimeSteps,M_Bermudan, Sigma,alpha,lambda,M, StrCallPut)-...
            price)./(slat{5}(1)-S0);
         
         
Delta_dsa11=(price-...
            priceOptionTrinCEVBermudanTry1(slat{5}(length(slat{5}(:))), Strike, r, T, ...
             NumOfTimeSteps,M_Bermudan, Sigma,alpha,lambda,M, StrCallPut))./(S0-slat{5}(length(slat{5}(:))));        
