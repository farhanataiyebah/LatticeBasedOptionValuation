function [ newXSamplePoints,smoothedYDelta, smoothedYGamma ] = Interp_AuxLatticeGreeksAsianA(Underlying, Strike, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut)

            
            
[x1,delta1, gamma1 ] = AuxLatticeGreeksAsianA(Underlying, Strike, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut);

[x2,delta2,gamma2]= AuxLatticeGreeksAsianA(min(x1), Strike, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut);
            k=0;
...
[x3,delta3,gamma3]= AuxLatticeGreeksAsianA(max(x1), Strike, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut);  
            k=0;
            for i=1:(2*NumOfTimeSteps+1)-4
            if (x3(i)>max(x1))
