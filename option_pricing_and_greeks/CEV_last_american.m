function [S,putprice] = CEV_last_american(contract,dynamics,FD,NumOfTimeSteps, Sigma,lambda,SgridM,S0, StrCallPut)
...
[S putprice]= american_prices(Underlying, K, r, T,NumOfTimeSteps, Sigma,elasticity,lambda,SgridM, StrCallPut);
S=S';
