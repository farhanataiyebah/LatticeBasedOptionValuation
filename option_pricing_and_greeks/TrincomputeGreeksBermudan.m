function [ delta2,delta, gamma ] = TrincomputeGreeksBermudan(Underlying, Strike, r, T, ...
...
deltaDown = (plat{3}(2)-plat{3}(3))/(slat{3}(2)-slat{3}(3));
gamma = max((deltaUp-deltaDown)/((slat{3}(1)-slat{3}(3))/2),0);
end
