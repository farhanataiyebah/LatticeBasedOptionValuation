function [S,putprice] = CEV_last_bermudan(contract,dynamics,FD,NumOfTimeSteps, Sigma,lambda,SgridM,S0, StrCallPut)
...
[S putprice]= bermudan_prices(Underlying, K, r, T,NumOfTimeSteps, Sigma,elasticity,lambda,SgridM, StrCallPut);
S=S';
