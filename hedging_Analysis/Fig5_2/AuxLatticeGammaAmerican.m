function [ gamma] = AuxLatticeGammaAmerican(Underlying, Strike, r, T, ...
...
[price, slat, plat] = priceOptionTrinCEVAmericanTry1(S0, Strike, r, T, ...
 ...
 k=0;
           ...
           gamma= (AuxLatticeDeltaAmerican(s(NumOfTimeSteps), Strike, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut)-AuxLatticeDeltaAmerican(s(NumOfTimeSteps+2), Strike, r, T, ...
