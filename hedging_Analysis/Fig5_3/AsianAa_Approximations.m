...
Call_1=priceOptionTrinCEVAsianTry1(S0, K1, r,T, ...
               NumOfTimeSteps,  Sigma,alpha,lambda,M, 'Call');
put=priceOptionTrinCEVAsianTry1(S0, K1, r,T, ...
               NumOfTimeSteps,  Sigma,alpha,lambda,M, 'Put');
            
Call_2=priceOptionTrinCEVAsianTry1(S0, K3, r,T, ...
              NumOfTimeSteps,  Sigma,alpha,lambda,M, 'Call');
 %%
...
Del_prfl    = m1*(AuxLatticeDeltaAsianA(S0, K1, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Put')) +  m2*(AuxLatticeDeltaAsianA(S0, K1, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Call'))...,  
                    + m3* (AuxLatticeDeltaAsianA(S0, K3, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Call'));
                
Gam_prfl    =  m1*(AuxLatticeGammaAsianA(S0, K1, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Put')) +  m2*(AuxLatticeGammaAsianA(S0, K1, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Call'))...,  
                    + m3* (AuxLatticeGammaAsianA(S0, K3, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Call'));
%[BS_Call_1, BS_Put] = blsprice(St, K1, r_51, T_51-tau, est_sig, q_51);
%BS_Call_2 = blsprice(St, K3, r_51, T_51-tau ,est_sig, q_51);

Asian_Call_1=priceOptionTrinCEVAsianTry1(St, K1, r, T-tau, ...
                NumOfTimeSteps,  Sigma,alpha,lambda,M, 'Call');
Asian_Put=priceOptionTrinCEVAsianTry1(St, K1, r, T-tau, ...
                NumOfTimeSteps,  Sigma,alpha,lambda,M, 'Put');
Asian_Call_2 =priceOptionTrinCEVAsianTry1(St, K3, r, T-tau, ...
                NumOfTimeSteps,  Sigma,alpha,lambda,M, 'Call');
