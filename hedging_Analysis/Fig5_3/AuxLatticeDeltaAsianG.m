function [ delta] = AuxLatticeDeltaAsianG(Underlying, Strike, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut)
          S0  = Underlying;

[price, slat, plat] = priceOptionTrinCEVAsianGTry1(S0, Strike, r, T, ...
               NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut);
 ...
 k=0;
           ...
           delta= (priceOptionTrinCEVAsianGTry1(s(NumOfTimeSteps), Strike, r, T, ...
               NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut)-priceOptionTrinCEVAsianGTry1(s(NumOfTimeSteps+2), Strike, r, T, ...
