function [ delta] = AuxLatticeDeltaAsianA(Underlying, Strike, r, T, ...
...
[price, slat, plat] = priceOptionTrinCEVAsianTry1(S0, Strike, r, T, ...
 ...
 k=0;
           ...
           delta= (priceOptionTrinCEVAsianTry1(s(NumOfTimeSteps), Strike, r, T, ...
               NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut)-priceOptionTrinCEVAsianTry1(s(NumOfTimeSteps+2), Strike, r, T, ...
