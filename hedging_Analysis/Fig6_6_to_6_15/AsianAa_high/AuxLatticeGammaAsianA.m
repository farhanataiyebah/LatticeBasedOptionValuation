function [ gamma] = AuxLatticeGammaAsianA(Underlying, Strike, r, T, ...
...
[price, slat, plat] = priceOptionTrinCEVAsianTry1(S0, Strike, r, T, ...
 ...
 k=0;
           ...
           gamma= (AuxLatticeDeltaAsianA(s(NumOfTimeSteps), Strike, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut)-AuxLatticeDeltaAsianA(s(NumOfTimeSteps+2), Strike, r, T, ...
