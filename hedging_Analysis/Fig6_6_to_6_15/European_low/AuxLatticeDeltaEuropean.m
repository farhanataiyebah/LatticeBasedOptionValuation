function [ delta] = AuxLatticeDeltaEuropean(Underlying, Strike, r, T, ...
...
[price, slat, plat] = priceOptionTrinCEVEuropeanTry1(S0, Strike, r, T, ...
 ...
 k=0;
           ...
           delta= (priceOptionTrinCEVEuropeanTry1(s(NumOfTimeSteps), Strike, r, T, ...
               NumOfTimeSteps, Sigma,alpha,lambda,M, StrCallPut)-priceOptionTrinCEVEuropeanTry1(s(NumOfTimeSteps+2), Strike, r, T, ...
