%Approximation errors of Greek-based (gamma) valuations increasing
...
title(' Approximation error(Increasing)for high market volatility 30% ')
%ylim([6.15,6.65]);
xlim([1340,1440]);
xlabel('Asset')
