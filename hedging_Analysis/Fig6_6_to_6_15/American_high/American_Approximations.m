...
Del_prfl    = m1*(AuxLatticeDeltaAmerican(S0, K1, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Put')) +  m2*(AuxLatticeDeltaAmerican(S0, K1, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Call'))...,  
                    + m3* (AuxLatticeDeltaAmerican(S0, K3, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Call'));
                
Gam_prfl    =  m1*(AuxLatticeGammaAmerican(S0, K1, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Put')) +  m2*(AuxLatticeGammaAmerican(S0, K1, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Call'))...,  
                    + m3* (AuxLatticeGammaAmerican(S0, K3, r, T, ...
                NumOfTimeSteps, Sigma,alpha,lambda,M, 'Call'));
